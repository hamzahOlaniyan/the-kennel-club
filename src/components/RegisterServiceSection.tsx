         ...
         <MediaQuery>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                  ...
                  <div className="space-y-8">
                     {[
                        ...
                        <div key={i} className="flex items-start">
                           <div className="w-12 h-12 bg-white shadow-md flex items-center justify-center rounded-sm mr-6 shrink-0">
               ...
               <div className="relative">
                  ...
                  />
                  <div className="bottom-14 relative rounded-lg md:bottom-24 md:-left-8 bg-regal-navy bg-slate-900 p-8 text-white max-w-xs  md:block">
                     <p className="italic font-serif mb-4">
                        "The Kennel Club Gambia provided the foundation my kennel needed to achieve international
                        recognition."
                     </p>
                     <p className="text-regal-gold text-xs font-bold uppercase tracking-widest">— Hamzah Olaniyan</p>
                  </div>
               </div>
            </div>
         </MediaQuery>
